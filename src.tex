...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
    \resumeItem{Built, with C and C++, a reproducible distributed latency evaluation system for new auto trading applications.}
    \resumeItem{Designed and implemented (C) low latency FPGA mocks to reduce development reliance on limited hardware.}
    \resumeItemListEnd
    \resumeSubheading
