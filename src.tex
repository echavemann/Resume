...
\section{Experience}
  \resumeSubHeadingListStart
      \resumeSubheading
      {Optiver}{Summer 2025}
      {Software Engineer - High Frequency Trading}{Austin, TX}
  \resumeSubHeadingListEnd
  \resumeSubHeadingListStart
      \resumeSubheading
    ...
    \resumeSubheading
      ...
      {Software Engineering Intern -- Screening Services}{Seattle, WA}
     \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: UNIX (RHEL), Cloud Infrastructure, APIs, Concurrency, Data Systems } \\
